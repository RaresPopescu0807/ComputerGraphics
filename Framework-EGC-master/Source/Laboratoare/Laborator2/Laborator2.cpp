...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(-1, 0,  0), glm::vec3(0.5, 0.5, 1)),
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 0.5, 0.5))
		...
		{
			VertexFormat(glm::vec3(3, 3,  4), glm::vec3(0, 1, 1)),
			VertexFormat(glm::vec3(4, 3,  4), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(3, 4,  4), glm::vec3(0, 1, 0)),
			
			VertexFormat(glm::vec3(3, 3,  3), glm::vec3(1, 0, 0))
		...
		vector<unsigned short> indices2 =
		{
			...
			vector<VertexFormat> vertices3
			{
				...
				VertexFormat(glm::vec3(-2, -3,  -2), glm::vec3(0, 0, 1)),
				VertexFormat(glm::vec3(-3, -2,  -2), glm::vec3(0, 1, 0)),
				VertexFormat(glm::vec3(-2, -2,  -2), glm::vec3(1, 0, 1)),
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["cube3"], shaders["VertexColor"], glm::vec3(1, 0, 1), glm::vec3(0.5f));

	RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(1, 0, 1), glm::vec3(0.5f));

	RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(1, 0, 1), glm::vec3(0.5f));
